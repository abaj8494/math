...
"""collatz.py
I misinterpretted the collatz conjecture and wrote a program to find the shortest
path following the collatz rules

Argument/s: takes in a positive integer `n` as an argument and calculates the shortest collatz sequence
...
we perform a breadth first search to find the shortest route.
"""
