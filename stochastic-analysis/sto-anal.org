...
:ROAM_ALIASES: "Melantha Wang"
:END:
#+TITLE: MATH5975 Introduction to Stochastic Analysis
...
#+LATEX_HEADER: \lhead{\textit{Melantha Wang}}
...
A family of subsets $\A \subset 2^\Omega$ is called a $\sigma$-algebra if it satisfise
...
*** Conditional Expectation w.r.t.\ a Partition
...
** Visual Representation of Expectation
...
#+LATEX: \newpage
#+LATEX: \section{Ito's Integral}\footnote{I will skip the definition of Ito's integral for elementary processes, which is required to formally define Ito's integral for more general processes as discussed here.}

** Ito's Integral for Processes from $L^2_\P(W)$
...
** Ito's Integral for Processes from $L_\P(W)$
...
** Ito's Lemma in Multidimensional Space
...
*** It\^o's Lemma for Continuous Semimartingales
...
** Martingale Representation Theorem (for the Brownian Filtration)
...
** It\^o's Existence and Uniqueness Theorem
...
** Stochastic Exponential and Stochastic Logarithmic
...
#+LATEX: \newpage
#+LATEX: \appendix
#+LATEX: \section[Some Useful Results]{Some Useful Results\protect\footnote{I may omit some technical conditions in this section.}}
